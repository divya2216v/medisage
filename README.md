...
Persistent UI Disclaimer: A globally visible notice banner that grounds user expectations.
Backend Payload Enforcement: The Python backend hijacks and intercepts the Gemini output. If the AI happens to omit the medical liability disclaimer, the backend forces it into the response before delivering it to the user.
